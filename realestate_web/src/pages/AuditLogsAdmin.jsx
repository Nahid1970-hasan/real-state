...
import { loadAdmALData, loadAdmALDataInit } from "../features/dashboard/adm_audit_log_slice";
...
export const AdminAuditLogsPage = () => {
  ...
  const auditLogsData = useSelector((state) => state.admLogData);
  ...
  useEffect(() => {
    auditLogsData.loading == "pending" ? setIsLoading(true) : setTimeout(() => setIsLoading(false), 2000);
  ...
  // let rows = auditLogsData?.dataList||[];
  return (
    <>
      <Flex row>
