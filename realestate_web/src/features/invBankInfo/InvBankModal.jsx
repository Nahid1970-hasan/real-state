...
import { saveInvBankInfo, updateInvBankInfo } from "./inv_bank_slice";

export const InvBankModal = ({add,open, setOpen = () => { }, data, }) => {
    ...
    const SubmitForm = (values) => {
        ...
        dispatch(add?saveInvBankInfo(values):updateInvBankInfo(values));
        set_disabled(true);
    };
