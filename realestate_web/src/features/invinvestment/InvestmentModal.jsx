...
import {
    ...
    saveInvestmentConfig as savetype,
    initLoader,
    InvSubmit,
...
export const InvestmentModal = ({ add, open, setOpen = () => { }, data }) => {
    ...
    useEffect(() => {
        var invData = Object.assign({
            ...investment?.Invlist || {}, buy_share: data?.buy_share || "0", total_amount: data?.total_amount || "0", remain_share: " " + parseInt(investment?.Invlist.no_share_for_sell || 0) - parseInt(investment?.Invlist.share_sold || 0)
        });
        set_project_data(invData);
    }, [investment.Invlist, data]);

    useEffect(() => {
        set_amnt_wallet(investment.walletAmount);
    }, [investment.walletAmount]);
    ...
    const validate = (Values) => {
        ...
        if (!Values.buy_share) {
            ...
            errors.buy_share = ("Shares to buy can not be more than your available share");
        }
    ...
    function countSharePrice(e) {
        ...
        var unitprice = investment?.Invlist?.unit_price || 0;
                                                ...
                                                <Flex row>
                                                    ...
                                                    <Flex padding="0 !important" md={6}>
                                                        ...
                                                        >
                                                            ...
                                                            {investment.projectlist?.map((d, i) => (
