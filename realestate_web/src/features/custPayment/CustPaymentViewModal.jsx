...
export const CustPaymentViewModal = ({ open, setOpen = () => { }, data }) => {
    ...
    return (
        ...
        >
            <>
                <Flex row>
                    <Flex padding="0 5px 10px 0 !important" md={6} sm={12}>
                        <Flex row>
                    ...
                    <Flex row>
                            ...
                            <Flex padding="5px 0 0 0!important" md={8} sm={6} xs={12}> <Typography textAlign="left" fontSize="bodySubTitleFontSize">
                        ...
                        <Flex row>
                            ...
                            <Flex padding="5px 0 0 0 !important" md={8} sm={6} xs={12}> <Typography textAlign="left" fontSize="bodyContentFontSize" >
                                {":"} {" "} <HLChip background={"primary"} color={"primaryFont"} label={detailsData?.payment_verified == "Yes" ? "Approved" : detailsData?.payment_submitted == "Yes" ? "Submitted" : "Requested" || "----"} />
                            </Typography>
                            </Flex>
                        </Flex>
