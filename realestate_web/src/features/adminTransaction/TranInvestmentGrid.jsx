...
export const TranInvestmentGrid = ({ setViewOpen, setUserData }) => {
    ...
    return <Suspense fallback={<Loader />}>
        <>
        {/* {invsummary.addUpdateLoading != "idle" && (
            invsummary.addUpdateLoading == "failed" ? (
                <Toast msg={invsummary.msg} color="error" />
            ) : (
                <Toast color="success" icon="task_alt" msg={invsummary.msg} />
            )
        )} */}
                 <Flex row>
            <CardBody>
