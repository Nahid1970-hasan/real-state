...
import { initLoader, saveBankInfo, updateBankInfo } from "./admin_bank_info_slice";
import { ErrLabel, Label } from "../../components/style/Label";
import { Input } from "../../components/style/Input_styled";

export const AdminBankModal = ({add,open, setOpen = () => { }, data, }) => {
    ...
    const SubmitForm = (values) => {
        ...
        dispatch(add?saveBankInfo(values):updateBankInfo(values));
        set_disabled(true);
    };
    ...
    return (<>
        <Modal
            ...
            sm={6}
            xs={10}
            title={(add?"Add Bank Information":"Update Bank Information")}
            open={open}
            onClose={() => {
                setOpen(false);
            }}
