...
export const AdminInvView = ({ open, setOpen = () => { }, data }) => {
            ...
            <>
                <Flex row>
                    ...
                    <Flex padding="0 0 0 10px !important" md={12} sm={12}>
                        ...
                        <Flex row>
                            <Flex padding="0 0 0 0 !important" md={4} sm={6} xs={12}><Typography textAlign="left" fontSize="bodyContentFontSize" fontWeight="bold">
                                {("Shares to Buy")}
                            </Typography></Flex>
                        ...
                        <Flex row>
                            ...
                            <Flex padding="0 !important" md={8} sm={6} xs={12}> <Typography textAlign="left" fontSize="bodyContentFontSize" >
                            {":"} {" "} <HLChip background={"primary"} color={"primaryFont"} label={detailsData?.buy_approved == "Yes" ? "Approved" : detailsData?.buy_submitted == "Yes" ? "Verified" : "Requested" || "----"} />
                            </Typography>
                            </Flex>
                        </Flex>
